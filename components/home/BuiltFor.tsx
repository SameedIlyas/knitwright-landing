      ...
      <Frame>
        ...
        <div ref={ref} onFocus={() => setPaused(true)} onBlur={() => setPaused(false)}>
          <div
            ...
            className="relative mt-12 h-[9.5rem] overflow-hidden rounded-[2rem] bg-white [mask-image:linear-gradient(90deg,transparent,#000_10%,#000_90%,transparent)]"
          >
            {slots.map((k) => {
              const offset = k - pos;
              ...
              return (
                <motion.button
                  ...
                  className="absolute left-1/2 top-1/2 flex h-[7.5rem] -translate-y-1/2 flex-col items-center justify-center gap-2.5 rounded-[1.6rem]"
                >
                  <span
                    aria-hidden="true"
                  ...
                  <span className="relative whitespace-nowrap text-[1.05rem] font-medium tracking-tight text-ink">{SEGMENT_MEDIA[idx].short}</span>
                </motion.button>
              );
            })}
          </div>
          ...
          <div className="mt-5 grid gap-5 lg:grid-cols-2" aria-live="polite">
            <div className="rounded-[2.5rem] bg-white p-4">
              ...
              <div className="flex items-end justify-between gap-6 px-4 pb-3 pt-6">
                <div>
            ...
            <div className="flex min-h-[24rem] flex-col justify-between gap-10 rounded-[2.5rem] bg-white p-8 sm:p-12">
